...
## Discrete model
@autodiff struct DiscreteModel <: RobotDynamics.DiscreteDynamics end
...
function jacobian_error(::StaticReturn, ::ForwardAD, model, J2, J1, y2, y1, z2::KnotPoint, z1::KnotPoint)
...
function jacobian_error(::InPlace, ::ForwardAD, model::DiscreteModel, J2, J1, y2, y1, z2::KnotPoint, z1::KnotPoint)
...
function jacobian_error(::StaticReturn, ::FiniteDifference, model::DiscreteModel, J2, J1, y2, y1, z2::KnotPoint, z1::KnotPoint)
...
function jacobian_error(::InPlace, ::FiniteDifference, model::DiscreteModel, J2, J1, y2, y1, z2::KnotPoint, z1::KnotPoint)
    f1!(_y, _z) = RD.dynamics_error!(model, _y, y1, z2, RD.StaticKnotPoint(z1, _z))
    FiniteDiff.finite_difference_jacobian!(J1, f1!, RD.getdata(z1), model.cache)
...
function test_error_allocs(model)
    ...
    allocs = 0
    allocs += @allocated jacobian_error(StaticReturn(), ForwardAD(), model, J2, J1, y2, y1, z2, z1)
    allocs += @allocated jacobian_error(InPlace(), ForwardAD(), model, J2, J1, y2, y1, z2, z1)
    allocs += @allocated jacobian_error(StaticReturn(), FiniteDifference(), model, J2, J1, y2, y1, z2, z1)
    allocs += @allocated jacobian_error(InPlace(), FiniteDifference(), model, J2, J1, y2, y1, z2, z1)
