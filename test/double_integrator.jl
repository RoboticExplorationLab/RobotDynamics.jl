...
@btime jacobian!(InPlace(), ForwardAD(), $model, $J, $y, $z)              # 9.4 us
@btime jacobian!(StaticReturn(), ForwardAD(), $model, $J, $y, $z)         # 330 ns
@btime jacobian!(InPlace(), FiniteDifference(), $model, $J, $y, $z)       # 5.1 us
@btime jacobian!(StaticReturn(), FiniteDifference(), $model, $J, $y, $z)  # 6.2 us
