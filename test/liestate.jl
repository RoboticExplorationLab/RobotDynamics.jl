...
function error_state_quat(x::AbstractVector, x0::AbstractVector)
    dq1 = QuatRotation(x[4], x[5], x[6], x[7]) ⊖ QuatRotation(x0[4], x0[5], x0[6], x0[7])
    dq2 = QuatRotation(x[10], x[11], x[12], x[13]) ⊖ QuatRotation(x0[10], x0[11], x0[12], x0[13])
    dx = x - x0
...
# Test params
@test Rotations.params(QuatRotation) == 4
...
q1 = QuatRotation(x[4], x[5], x[6], x[7])
q2 = QuatRotation(x[10], x[11], x[12], x[13])
...
RobotDynamics.LieState(::LieBody) = LieState(QuatRotation{Float64}, (3, 2, 3))
