...
length(s) == 16
error_size(s) == 14
vec_inds(R,P,1) == 1:3   == inds(R,P,1)
rot_inds(R,P,1) == 4:7   == inds(R,P,2)
vec_inds(R,P,2) == 8:9   == inds(R,P,3)
rot_inds(R,P,2) == 10:13 == inds(R,P,4)
vec_inds(R,P,3) == 14:16 == inds(R,P,5)

n = length(s)
x  = @MVector rand(n)
x0 = @MVector rand(n)
state_diff(s, x, x0) ≈ error_state_quat(x, x0)
...
error_size(s) == 14
vec_inds(R,P,1) == 1:3   == inds(R,P,1)
rot_inds(R,P,1) == 4:6   == inds(R,P,2)
vec_inds(R,P,2) == 7:8   == inds(R,P,3)
rot_inds(R,P,2) == 9:11  == inds(R,P,4)
vec_inds(R,P,3) == 12:14 == inds(R,P,5)
error_state(s, x, x0) ≈ error_state_rp(x, x0)
